...
// Command     : write_verilog -force -mode synth_stub -rename_top design_5_axi_smc_0 -prefix
//               design_5_axi_smc_0_ design_5_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_5_axi_smc_0,bd_9fd6,{}" *) (* CORE_GENERATION_INFO = "design_5_axi_smc_0,bd_9fd6,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_9fd6,Vivado 2025.1" *) 
module design_5_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
