...
#
# Script generated by Vivado on Wed Mar 18 11:36:12 +0530 2026
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_378d.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
