...
#
# Script generated by Vivado on Thu Mar 19 15:01:31 +0530 2026
...
# script info
echo -e "design_3.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L ahblite_axi_bridge_v3_0_29 -L axi_ahblite_bridge_v3_0_31 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_11 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_protocol_converter_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_3 xil_defaultlib.design_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_3 -key {Behavioral:sim_1:Functional:design_3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f00d.protoinst" -protoinst "protoinst_files/bd_978d.protoinst" -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_378d.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
