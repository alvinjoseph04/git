...
(* CORE_GENERATION_INFO = "design_5,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_5,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_5.hwdef" *) 
module design_5
   (CAN_0_0_rx,
    CAN_0_0_tx,
    DDR_addr,
    ...
    iic_rtl_sda_o,
    iic_rtl_sda_t);
  (* X_INTERFACE_INFO = "xilinx.com:interface:can:1.0 CAN_0_0 RX" *) (* X_INTERFACE_MODE = "Master" *) input CAN_0_0_rx;
  ...
  design_5_axi_iic_0_1 axi_iic_0
  ...
  design_5_processing_system7_0_0 processing_system7_0
       (.CAN0_PHY_RX(CAN_0_0_rx),
        .CAN0_PHY_TX(CAN_0_0_tx),
        .DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  design_5_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
