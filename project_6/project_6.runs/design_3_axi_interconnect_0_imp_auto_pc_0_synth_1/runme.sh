...
HD_PWD='C:/Users/291914/project_6/project_6.runs/design_3_axi_interconnect_0_imp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_axi_interconnect_0_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_axi_interconnect_0_imp_auto_pc_0.tcl
